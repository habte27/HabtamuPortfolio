  ...
  const education = [
    {
      ...
      period: '2011 - 2014',
      location: 'Ethiopia',
      description: 'Focused on  theoretical and technical funduation of computing including algorithms,data structures,programing ,software engineering and system design.'
    },
    {
      degree: 'Masters of Science in Computer Science and Engineering',
      institution: 'Adma Science and Technology University',
      period: '2021 - 2022',
      location: 'Ethiopia',
      description: 'Focused on advanced theoretical and practical aspects of computer science and engineering, with emphasis on algorithms, data structures, software engineering, system architecture, and research in cloud computing integrated with deep learning and artificial intelligence (AI).'
    }
  ];
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">habteshiferaw27@gmail.com</div>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">+251 921505027| +251 900650170</div>
                  </div>
                </div>
                <div className="flex items-center">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="mailto:habteshiferaw27@gmail.com" className="bg-gray-100 p-3 rounded-lg text-gray-600 hover:bg-blue-100 hover:text-blue-600 transition-colors">
                    <Mail size={20} />
                  </a>
                </div>
              </div>
